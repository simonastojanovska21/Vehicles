 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.vehicle.components.helloworld;
...
out.write("\r\n    ");
_global_model = renderContext.call("use", com.vehicle.core.models.HelloWorldModel.class.getName(), obj());
{
